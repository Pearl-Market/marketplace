...
export default function PostMintDialog({ colorScheme, publicTxnLoadingStatus, publicTxnSuccessStatus, publicTxnHashLink }) {
    ...
    console.log("link: ", publicTxnHashLink);
    console.log("hash: ", publicLocalTxnHash)
                        ...
                        <Dialog as="div" className="relative z-[60]" onClose={closeModal}>
                            ...
                            <div className="fixed inset-0 overflow-y-auto">
                                <div className="flex min-h-full items-center justify-center p-4 text-center">
                                    ...
                                    >
                                        <Dialog.Panel className="w-fit transform overflow-hidden bg-white align-middletransition-all shadow-[0_0px_30px_10px_rgba(0,0,0,1)]" >
